...
var _starter = function(){
  ...
  var grd = ctx.createLinearGradient(120,0,300,0);
   ...
   ctx.fillRect(594, 627, 3, 3);
   ctx.fillRect(609, 627, 3, 3);
...
var _descript = function(){

   ctx.clearRect(0, 0, WIDTH, HEIGHT);

   for(var i in description){
    drawText(description[i], 3, '#4BB135', 170, i * 30 +200);
   }

   drawText("move Control", 3.5, '#FFFFFF', 220, 430);
   drawText("W A S D", 4, '#FFFFFF', 140, 460);
   drawText("or", 3, '#FFFFFF', 288, 465);
   drawText("arrow key", 4, '#FFFFFF', 350, 460);

   if(ig2 == 0){
        drawText("Press space to continue", 4, 'rgba(255,255,255,0.5)', 130, HEIGHT / 3 * 2 + 100);
    }
}
